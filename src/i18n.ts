...
const translations = {
  ...
  "privacy.body": { en: "This application is intended for internal use only. We do not store customer names, addresses, email addresses, or phone numbers in our database; this information appears only in order confirmation emails, which are processed by our third-party email provider (Resend) and retained for up to 30 days before deletion. To learn more, please contact info@modernniagaraapparel.ca.", fr: "Cette application est réservée à un usage interne. Nous ne conservons pas dans notre base de données les noms, adresses, adresses courriel ni numéros de téléphone des clients; ces renseignements figurent uniquement dans les courriels de confirmation de commande, traités par notre fournisseur de courriel tiers (Resend) et conservés pendant un maximum de 30 jours avant leur suppression. Pour en savoir plus, veuillez communiquer avec info@modernniagaraapparel.ca." },
  // Header nav
