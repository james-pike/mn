  ...
  return (
    <div class="apparel-catalog" id="products">
      <nav class="pdp-breadcrumb" aria-label="Breadcrumb">
        ...
        <Link href={`/apparel/#${catHash}`} class="pdp-breadcrumb__link pdp-breadcrumb__cat">
        ...
        {/* Mobile: toggle between full-width image and the right preview rail.
            The icon shows the view you'll switch TO. Only shown when the product
            has more than one image — with a single image there's nothing to page. */}
        {hasMultipleImgs && (
          <button
