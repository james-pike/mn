...
const seeds: Seed[] = [
  ...
  { sku: "MN-24", name: "2 Buds Pro Wireless ANC Earbuds - White", category: "New Hire Kit", sizes: "One Size", colors: ["#ffffff"], price: 0, details: "Active noise cancellation, Wireless charging case, Charging cable included, 2 Buds, #70300" },
